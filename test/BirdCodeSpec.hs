...
spec = do
  it "Fixed Tests" $ do
    ...
    test ["IVuIznk-MyCySmf tCMDVxtCHu","nrUcsWEh bzfNgoLW wDTHoOHt","kaSjgpKt arkcqHopvd","MlDaWlPi oZdldSqt qRPmsmYR-ImxxNPZP","VhoImo JQqFoBi"] ["IMTC","NBWD","KAAR","MOQI","VHJQ"]
