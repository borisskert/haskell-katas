module Haskell.SylarDoom.FruitMachineSpec where

import Haskell.SylarDoom.FruitMachine
import Test.Hspec
    ...
    describe "should work for some examples" $ do
      ...
      it "Example #4" $ do
        fruit
          ...
          [0, 5, 0]
          `shouldBe` 6
      it "Failing example #1" $ do
        fruit
          [ ["Bell", "Bar", "Cherry", "Wild", "Star", "King", "Jack", "Seven", "Queen", "Shell"],
            ["Bell", "Star", "Jack", "King", "Seven", "Wild", "Cherry", "Queen", "Bar", "Shell"],
            ["Shell", "Jack", "Cherry", "Star", "King", "Bar", "Wild", "Bell", "Seven", "Queen"]
          ]
          [ 0,
            6,
            7
