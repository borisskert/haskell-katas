module Codewars.Kata.Caesar2Spec where

import Codewars.Kata.Caesar2
import Test.Hspec
...
spec = do
  ...
  describe "Composition of encodeStr and decode" $ do
    ...
    it "should decrypt" $ do
      decode ["ijJ tipvme ibw", "f lopxo uibu z", "pv xpvme ibwf ", "b qfsgfdu botx", "fs gps nf!!!"]
        `shouldBe` "I should have known that you would have a perfect answer for me!!!"

    it "should decrypt with another prefix" $ do
      decode ["zaJ tipvme ibw", "f lopxo uibu z", "pv xpvme ibwf ", "b qfsgfdu botx", "fs gps nf!!!"]
        `shouldBe` "I should have known that you would have a perfect answer for me!!!"
