module Codewars.G964.CommonsubsSpec (spec) where
import Codewars.G964.Commonsubs (substringTest)  
...
spec = do
    ...
    describe "substringTest" $ do
        ...
        testSub "zqgvaerlxboyhjnzjzmnzxwxfrmfbmhi" "rtsyceralztcpa" True
